...
public class BreathBubbleView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public BreathBubbleView(Context context) {
        super(context);
        initThreadAndHolder(context);
    }

    public BreathBubbleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initThreadAndHolder(context);
    }

    public BreathBubbleView(Context context, AttributeSet attrs, int defStyleAttr) {
